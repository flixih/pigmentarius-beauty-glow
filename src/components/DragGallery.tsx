...
import pg10 from "@/assets/pg-10.webp";
import pg11 from "@/assets/pg-11.webp";
import pg12 from "@/assets/pg-12.webp";
import pg13 from "@/assets/pg-13.webp";
import pg14 from "@/assets/pg-14.webp";
import pg15 from "@/assets/pg-15.webp";
import pg16 from "@/assets/pg-16.webp";

const photos = [
  g01, g02, g03, g04, g05, g06, g07, g08, g09,
  pg01, pg02, pg03, pg04, pg05, pg06, pg07, pg08,
  pg09, pg10, pg11, pg12, pg13, pg14, pg15, pg16,
];
...
const DragGallery = () => {
  ...
  return (
    <section id="galeria" className="py-20 md:py-32 overflow-hidden" style={{ background: pal.sectionBg, transition: "background 0.4s ease" }}>
      ...
      <div ref={trackRef}
        className="flex gap-3 px-6 md:px-12 overflow-x-scroll select-none"
        style={{ scrollbarWidth: "none", cursor: isDragging ? "grabbing" : "grab", userSelect: "none" }}

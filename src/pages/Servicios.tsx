  ...
  <div className="group bg-background border border-border rounded-2xl overflow-hidden hover:shadow-elevated transition-all duration-300 hover:-translate-y-0.5">
    ...
    <div className="p-3 md:p-4">
      <div className="flex justify-between items-start mb-1.5 gap-1">
        ...
        <span className="text-primary font-bold text-xs md:text-sm whitespace-nowrap flex-shrink-0 ml-1">{price}</span>
      </div>
  ...
  const allServices = [
    {
      ...
      items: [
        { photo: IMG.haircut,    name: { es: "Corte de Cabello",          en: "Haircut"                  }, price: "$25",        desc: { es: "Especialistas en rizado, liso, fino o grueso.",               en: "Specialists in curly, straight, fine or thick hair."       } },
        { photo: IMG.color,      name: { es: "Coloración",                en: "Hair Color"               }, price: "Desde $80",  desc: { es: "Color vibrante con productos profesionales.",                  en: "Vibrant color with professional products."                } },
        { photo: IMG.highlights, name: { es: "Highlights & Balayage",     en: "Highlights & Balayage"    }, price: "Desde $90",  desc: { es: "Mechas y balayage de aspecto natural.",                        en: "Natural-looking highlights and balayage."                  } },
        { photo: IMG.keratina,   name: { es: "Keratina",                  en: "Keratin Treatment"        }, price: "Desde $79",  desc: { es: "Control total del frizz. Perfecto para el clima de PR.",       en: "Total frizz control. Perfect for PR's tropical climate."   } },
        { photo: IMG.botox,      name: { es: "Botox Capilar",             en: "Hair Botox"               }, price: "$90",        desc: { es: "Rejuvenecimiento profundo con colágeno.",                       en: "Deep rejuvenation with collagen for silky hair."           } },
        { photo: IMG.repair,     name: { es: "Cirugía Plástica Capilar",  en: "Hair Repair Treatment"    }, price: "Desde $189", desc: { es: "Tratamiento intensivo para cabello muy dañado.",               en: "Intensive repair treatment for severely damaged hair."     } },
        { photo: IMG.blowout,    name: { es: "Brazilian Blowout",         en: "Brazilian Blowout"        }, price: "Desde $99",  desc: { es: "Alisado suave y duradero con brillo intenso.",                 en: "Smooth, long-lasting straightening with intense shine."    } },
      ],
    },
    {
      ...
      items: [
        { photo: IMG.microblading, name: { es: "Microblading",                  en: "Microblading"           }, price: "$370",       desc: { es: "Trazos ultra finos semi-permanentes. Retoque incluido.",     en: "Ultra-fine semi-permanent strokes. Touch-up included."    } },
        { photo: IMG.ombre,        name: { es: "Sombreado de Cejas (Ombré)",    en: "Brow Shading (Ombré)"   }, price: "$270",       desc: { es: "Sombreado suave para cejas con más densidad.",              en: "Soft shading for fuller, more natural-looking brows."     } },
        { photo: IMG.cejas,        name: { es: "Diseño de Cejas",               en: "Brow Design"            }, price: "Desde $30",  desc: { es: "Diseño experto que enmarca y realza tu rostro.",            en: "Expert design that frames and enhances your face."        } },
        { photo: IMG.wax,          name: { es: "Wax de Cejas",                  en: "Brow Wax"               }, price: "$12",        desc: { es: "Depilación con cera para cejas perfectamente definidas.",   en: "Waxing for perfectly defined brows."                      } },
        { photo: IMG.pmu_labios,   name: { es: "Maquillaje Permanente Labios",  en: "Permanent Lip Makeup"   }, price: "Consultar",  desc: { es: "Labios perfectamente definidos cada mañana.",              en: "Perfectly defined lips effortlessly every morning."       } },
        { photo: IMG.delineado,    name: { es: "Delineado Permanente",          en: "Permanent Eyeliner"     }, price: "Consultar",  desc: { es: "Ojos definidos sin maquillaje diario.",                    en: "Defined, expressive eyes without daily makeup."           } },
      ],
    },
    {
      ...
      items: [
        { photo: IMG.laser_face, name: { es: "Rostro Completo",    en: "Full Face"      }, price: "$65",        desc: { es: "Tratamiento completo de rostro.",          en: "Full face laser treatment."              } },
        { photo: IMG.laser_face, name: { es: "Bigote",             en: "Upper Lip"      }, price: "$25",        desc: { es: "Resultados desde la primera sesión.",      en: "Visible results from the first session." } },
        { photo: IMG.laser_face, name: { es: "Mentón",             en: "Chin"           }, price: "$25",        desc: { es: "Eliminación permanente del vello.",        en: "Permanent hair removal on the chin."     } },
        { photo: IMG.laser,      name: { es: "Axilas",             en: "Underarms"      }, price: "$25",        desc: { es: "Piel suave y libre de vello.",             en: "Smooth, hair-free underarms."            } },
        { photo: IMG.laser_legs, name: { es: "Piernas Completas",  en: "Full Legs"      }, price: "Desde $145", desc: { es: "Piernas perfectamente suaves para siempre.", en: "Perfectly smooth legs permanently."    } },
        { photo: IMG.laser,      name: { es: "Zona Bikini",        en: "Bikini Area"    }, price: "$45",        desc: { es: "Tratamiento de zona bikini clásica.",      en: "Classic bikini area treatment."          } },
        { photo: IMG.laser,      name: { es: "Laser Brazilian",    en: "Laser Brazilian"}, price: "$65",        desc: { es: "Tratamiento completo zona brasileña.",     en: "Full Brazilian area treatment."          } },
        { photo: IMG.laser,      name: { es: "Cuerpo Completo",    en: "Full Body"      }, price: "Consultar",  desc: { es: "Olvídate de la cera y la rasuradora.",     en: "Forget waxing and razors forever."       } },
      ],
    },
    {
      ...
      items: [
        { photo: IMG.nails,    name: { es: "Shellac / Gel",         en: "Shellac / Gel"       }, price: "$20", desc: { es: "Esmalte en gel de larga duración.",              en: "Long-lasting gel polish."               } },
        { photo: IMG.pedicure, name: { es: "Pedicura",              en: "Pedicure"            }, price: "$45", desc: { es: "Relajante tratamiento completo de pies.",        en: "Relaxing complete foot treatment."      } },
        { photo: IMG.facial,   name: { es: "Facial Rejuvenecedor",  en: "Rejuvenating Facial" }, price: "$55", desc: { es: "Limpieza profunda y tratamiento revitalizante.", en: "Deep cleanse and revitalizing facial."  } },
      ],
    },
  ];
